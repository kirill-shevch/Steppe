...
public static class StateCatalog
{
    ...
    [
        ...
        D(SimulationLayer.SoilCompaction, StateGroup.Soil, "ПОЧВА", 180, "Уплотнение почвы", "Уплотнение", "Долговременный след тяжёлых животных: уменьшает инфильтрацию, усиливает поверхностный сток и постепенно снимается корнями, влагой и промерзанием.", "доля", StateKind.Raw, StateScale.Linear, 0, 1, 2, "#806d5b", SoilPalette),
        ...
        D(SimulationLayer.Precipitation, StateGroup.Atmosphere, "ЭНЕРГИЯ И ВОЗДУХ", 290, "Интенсивность осадков", "Осадки", "Скорость возврата облачной воды на поверхность дождём или снегом.", "мм/ч", StateKind.Raw, StateScale.Logarithmic, 0, 20, 3, "#69aede", WaterPalette),
